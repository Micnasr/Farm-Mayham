...
public class CarrotDispenser : MonoBehaviour
{
    ...
    void OnTriggerStay(Collider other)
    {
        if (other.transform.tag == "hand")
        {
            ...
            {
                clone = Instantiate(CarrotSeed, hand.transform.position, Quaternion.identity);
        ...
        if (other.transform.tag == "hand2")
        {
            ...
            {
                clone = Instantiate(CarrotSeed, hand2.transform.position, Quaternion.identity);
